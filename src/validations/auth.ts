...
const validations = {
  ...
  solvenciaRRI: check('tramite.datos.solvenciaRRI').exists().withMessage('Debe especificar la accion a realizar').isString().isLength({ min: 1 }).withMessage('El nada no puede ser vacio'),
