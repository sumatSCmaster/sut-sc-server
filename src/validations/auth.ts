...
const validations = {
  ...
  siglas: check('tramite.datos.siglas').optional().withMessage('Debe incluir las siglas de la empresa').isString().isLength({ min: 1 }).withMessage('Las siglas no pueden ser vacias'),
