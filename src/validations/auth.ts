...
const validations = {
  ...
  inputRRI: check('tramite.datos.inputRRI').exists().withMessage('Debe especificar la accion a realizar').isString().withMessage('El campo de RRI no puede ser vacio')
};
