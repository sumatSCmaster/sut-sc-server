...
`,
  ...
  GET_SOLVENCY_A_RIM_CANDIDATES_BY_RIF: `SELECT EXISTS(SELECT COUNT(*) FROM tramite WHERE datos#>>'{usuario, tipo_documento}' = 'J' AND (datos#>>'{usuario, documento}')::VARCHAR = '12346567' AND id_tipo_tramite = 113)`,
