...
`,
  ...
  GET_APPLICATION_VIEW_BY_SETTLEMENT: 'SELECT l.*, l.certificado AS "solvencia", r.descripcion_corta AS "descripcionCortaRamo" FROM impuesto.liquidacion l INNER JOIN impuesto.subramo sr ON sr.id_subramo = l.id_subramo INNER JOIN impuesto.ramo r ON r.id_ramo = sr.id_ramo WHERE l.id_liquidacion = $1 ',
