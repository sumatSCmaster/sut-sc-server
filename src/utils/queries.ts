...
`,
  ...
  GET_SOLVENCY_A_RIM_CANDIDATES_BY_RIF: `SELECT EXISTS(SELECT COUNT(*) FROM tramite WHERE datos#>>'{usuario, tipo_documento}' = $1 AND (datos#>>'{usuario, documento}')::VARCHAR = $2 AND fecha_culminacion > $3 AND id_tipo_tramite = 113)`,
