...
router.post('/login', authenticate('local'), authValidations.login, checkResult, async (req: any, res) => {
...
router.post('/createAdmin', authValidations.createAdmin, checkResult, async (req, res) => {
