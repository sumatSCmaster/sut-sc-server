...
CREATE FUNCTION public.insert_tramite(_id_tipo_tramite integer, datos json, _id_usuario integer) RETURNS record
    LANGUAGE plpgsql
    AS $$
DECLARE
    tramite record;
    BEGIN
        INSERT INTO TRAMITES (id_tipo_tramite, id_status_tramite, datos, id_usuario, fase) VALUES (_id_tipo_tramite, 1, datos, _id_usuario, 1) RETURNING * into tramite;
...
1	1	primer tramite	200	\N
2	1	segundo tramite	201	\N
3	1	tercer tramite	200	\N
4	2	matenem	2000	\N
\.
...
COPY public.tramites (id_tramite, id_tipo_tramite, id_status_tramite, datos, costo, fecha_creacion, codigo_tramite, consecutivo, id_usuario, fase) FROM stdin;
1	4	1	\N	\N	\N	\N	\N	\N	\N
2	3	1	\N	\N	\N	\N	\N	\N	\N
7	4	1	\N	\N	2020-02-27 11:32:25.699002-04	\N	1	\N	\N
14	4	1	\N	\N	2020-02-27 11:37:46.676594-04	HMT-27022020-4-0002	2	\N	\N
15	4	1	\N	\N	2020-02-27 11:37:47.853056-04	HMT-27022020-4-0003	3	\N	\N
16	4	1	\N	\N	2020-02-27 12:08:54.370959-04	HMT-27022020-4-0004	4	\N	\N
17	3	1	\N	\N	2020-02-27 12:09:17.044276-04	CMB-27022020-3-0001	1	\N	\N
18	1	1	{}	\N	\N	CMB-29022020-1-0001	1	53	1
\.
...
SELECT pg_catalog.setval('public.eventos_tramite_id_evento_tramite_seq', 29, true);
...
SELECT pg_catalog.setval('public.tramites_id_tramite_seq', 18, true);
