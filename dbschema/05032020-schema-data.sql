...
--
-- Name: update_tramite_state(integer, text, json); Type: FUNCTION; Schema: public; Owner: -
--
...
SELECT pg_catalog.setval('public.eventos_tramite_id_evento_tramite_seq', 56, true);
...
SELECT pg_catalog.setval('public.tramites_id_tramite_seq', 30, true);
...
--
-- Name: pagos pagos_fecha_de_pago_referencia_id_banco_key; Type: CONSTRAINT; Schema: public; Owner: -
--
