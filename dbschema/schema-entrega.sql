...
0	0	Casos Sociales	\N	f	Casos Sociales	ABMM-001
\.
...
SELECT pg_catalog.setval('public.eventos_tramite_id_evento_tramite_seq', 87, true);
...
SELECT pg_catalog.setval('public.tramites_id_tramite_seq', 38, true);
