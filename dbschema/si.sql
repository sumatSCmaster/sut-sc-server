    ...
    --Obtiene el id del pago
        ...
        IF idPago IS NOT NULL THEN
            ...
            IF (SELECT concepto FROM pago WHERE id_pago = idPago) = 'CONVENIO' THEN
                ...
                select row_to_json(row)::jsonb into dataPago from (select pago.id_pago AS id, pago.monto, pago.aprobado, pago.id_banco AS idBanco, (SELECT id_procedimiento FROM pago WHERE id_pago = idPago) AS idProcedimiento, pago.referencia, pago.fecha_de_pago AS fechaDePago, pago.fecha_de_aprobacion AS fechaDeAprobacion, pago.metodo_pago AS "metodoPago", pago.concepto, contribuyente.tipo_documento AS nacionalidad, contribuyente.documento,
...
COPY impuesto.actividad_economica_sucursal (id_actividad_economica_contribuyente, id_contribuyente, numero_referencia) FROM stdin;
19	57	2005001
20	57	3053002
21	58	3001001
22	58	3010001
...
289	242	8888899999	56145000	2020-07-01	t	21	2020-07-01 14:36:28.350918+00	IMPUESTO	PUNTO DE VENTA	\N
290	247	890765444	25000000	2020-07-01	t	21	2020-07-01 14:55:15.967365+00	IMPUESTO	TRANSFERENCIA	\N
...
--
-- Name: actividad_economica_sucursal actividad_economica_contribuyente_id_contribuyente_fkey; Type: FK CONSTRAINT; Schema: impuesto; Owner: pooijyzcnnfrso
--
