...
--
-- Name: update_tramite_state(integer, text, json, numeric); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.update_tramite_state(_id_tramite integer, event text, _datos json DEFAULT NULL::json, _costo numeric DEFAULT NULL::numeric) RETURNS TABLE(state text)
    LANGUAGE plpgsql
    AS $$
  BEGIN
...
ALTER FUNCTION public.update_tramite_state(_id_tramite integer, event text, _datos json, _costo numeric) OWNER TO postgres;
...
1	1	primer tramite	200.02	f	tramite 1	\N
\.
...
SELECT pg_catalog.setval('public.eventos_tramite_id_evento_tramite_seq', 113, true);
...
SELECT pg_catalog.setval('public.tramites_id_tramite_seq', 55, true);
